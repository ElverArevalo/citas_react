  ...
  return (
    <div className='mx-5 mt-5 shadow-md rounded-xl px-5 py-10 bg-white'>
      ...
      <div className='text-center'>
        <button className='bg-orange-500 p-3 rounded-md w-1/4 m-5 font-bold text-white hover:bg-orange-400 '
        type='button'
        onClick={() => setPaciente(paciente)}>
          Editar
        </button>
        <button className='bg-red-900 p-3  rounded-md w-1/4 m-5 font-bold  text-white hover:bg-red-700'
        type='button'
